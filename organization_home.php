<?php include('orgnization_server.php')
    ...
    <div class="navigation-menu">
      <div class="menu1">
        <div class="dropdown1">
		  ...
		  <a href="organization_login.php">Sign Out</a>
...
window.onclick = function(event) {
  if (!event.target.matches('.dropbtn1')) {
    ...
    for (i = 0; i < dropdowns.length; i++) {
      ...
      <div class="menu5">
        <a href="Post For Ads.html" target="_blank">Post For Ads</a>
      </div>
    </div>
  </div>
...
<div class="container">
  <div class="side-bar">
    ...
    <div class="side-menu">
      ...
      <li><a href="#" title="Welcome" target="_blank" >Problem And Solve</a></li>
      <li><a href="#" title="Welcome" target="_blank" >Agriculture Tips</a></li>
      <li><a href="#" title="Welcome" target="_blank">Terms And Condition </a></li>
      <li><a href="#" title="Welcome" target="_blank" >Future Plan</a></li>
      <li><a href="#" title="Welcome" target="_blank" >Contact</a></li>
      </ul>
    </div>
  </div>
