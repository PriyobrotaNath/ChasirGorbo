...
<form method="post" action="organization_home.php">
				<button onclick="myFunction1()" class="dropbtn1">Sign In</button>
				...
				<p>
				<br>
				Not a member?<a href="farmer_register.php">Sign Up</a>
				</p>
				</div>
...
<div class="footer">
  <div class= "footer-menu">
			<div class="footer-logo"> <img src="images/cg.png" width="60px" height="60px"> 
			</div>
			<div class="details">
			  <h4>Our Details</h4>
			</div>
